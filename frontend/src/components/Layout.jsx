      ...
      <footer className="bg-white py-8 border-t border-gray-200">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div>
              ...
              <p className="text-sm text-gray-500">
                Herramienta de análisis y seguimiento de precios para ayudarte a tomar mejores decisiones de compra.
              </p>
            </div>
            <div>
              <h3 className="text-sm font-semibold text-gray-500 tracking-wider uppercase mb-4">
          ...
          <div className="mt-8 pt-8 border-t border-gray-200 flex flex-col md:flex-row md:justify-between md:items-center">
            <p className="text-sm text-gray-500">
              &copy; {new Date().getFullYear()} PriceTrack - Todos los derechos reservados
            </p>
